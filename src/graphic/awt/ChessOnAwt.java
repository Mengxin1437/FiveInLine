...
public class ChessOnAwt implements MouseListener {
    ...
    public ChessOnAwt(MyCanvas myCanvas, Chess chess, Thread userThread) {
        ...
        this.chess = chess ;
        this.clientThread = (ClientThread)userThread ;
        this.clientThread.setMyCanvas(myCanvas) ;
        this.clientThread.setChessOnAwt(this) ;
        socket = this.clientThread.getSocket();
    }
